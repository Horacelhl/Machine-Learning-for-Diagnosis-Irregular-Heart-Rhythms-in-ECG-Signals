...
def plot_history(history):
    ...
    plt.ylabel('Accuracy')
    plt.legend()
    plt.savefig(sec_path + 'training_history_72000_v1%d.png'%EPOCHS)
    plt.show()    
...
def CNN1DLSTM():
    ...
    model_checkpoint_callback = ModelCheckpoint(sec_path + 'weight_72000_v1%d.hdf5'%EPOCHS, save_best_only=True, monitor='val_loss', mode='min')
    ...
    with open(sec_path + 'history_72000_v1%d.csv'%EPOCHS, mode='w') as f:
        result.to_csv(f)
        hist_df.to_csv(f)
